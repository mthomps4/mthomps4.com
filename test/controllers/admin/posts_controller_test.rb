...
class AdminPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post" do
    assert_difference("Post.count") do
      post admin_posts_url, params: {post: {content: @post.content, description: @post.description, title: @post.title}}
    end
  ...
  test "should update post" do
    patch admin_post_url(@post), params: {post: {content: @post.content, description: @post.description, title: @post.title}}
