  ...
  def default_meta_tags
    {
      ...
      title: 'Home',
      reverse: true,
      desctription: "Matt Thompson is a Software Architect by day and 'Unplugged Engineer' by night honing his craft to build in both the digital and physical world. Matt is also passionate about mentoring others and promating growth opportunities throughout.",
